...
import {
    Box, AppBar, Toolbar, IconButton, Typography, Avatar, Divider,
    List, ListItem, ListItemIcon, ListItemText
} from "@material-ui/core";
import {Apps, ArrowBack, AssignmentInd, ContactMail, Home, ChromeReaderMode} from "@material-ui/icons";
...
export const Navbar = () => {
    ...
    const sidevar = slider => (
        <Box component={'div'} className={styles.menuContainer} onClick={() => toogleSlider(slider, false)}>
            ...
            <List>
                {menuIcons.map((listItem, key) => (
                    <ListItem button key={key} component={Link} to={listItem.listPath}>
                        ...
                        <ListItemText className={styles.listItem} primary={listItem.listText}/>
                    </ListItem>
                ))}
            </List>
        </Box>
            ...
            <Box component={'nav'}>
                <AppBar position={'static'} style={{background: "#222"}}>
                    <Toolbar>
                        ...
                        <MobilRightMenuSlider anchor={'left'} open={state.right}
